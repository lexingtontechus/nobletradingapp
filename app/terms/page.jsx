  ...
  return (
    <div className="container p-8 mx-auto">
      <div className="my-2">
        ...
        Trading App, LLC. Throughout the site and associated services, the terms
        “we”, “us”, and “our” refer to Noble Trading. Noble Trading offers this
        website, including all information, mobile device applications (the
        "Apps"), tools, and services available from this site and its integrated
        platforms, including the Discord bot, to you, the user ("you", "your",
        "yourself"). By accessing or using any part of the site, Apps, or
        Discord bot, you agree to be bound by these Terms of Service.
      </div>
      <div>
        These Terms of Service apply to all users of the platform, including
        browsers, vendors, customers, merchants, and contributors of content.
        Please read these Terms of Service carefully before accessing or using
        our website. If you do not agree to all the terms and conditions of this
        agreement, including any changes made over time, then you may not access
      ...
      <div>
        Any new features or tools added to the current subscriptions, including
        those integrated into the website, Apps, or Discord bot, shall also be
        ...
        access to the website, Apps, or Discord bot following the posting of any
      ...
      <div>
        You may not use our products for any illegal, against any market
        regulations, or unauthorized purpose nor may you, in the use of the
        Service, violate any laws or regulations in your jurisdiction (including
        but not limited to copyright laws) along with SEC and/or FINRA
        regulations or rules. You must not transmit any worms or viruses or any
        code of a destructive nature. A breach or violation of any of the Terms
        will result in the immediate termination of your Services.
      </div>
      <div className="my-4">
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" defaultChecked />
          <div className="collapse-title font-semibold">General Usage</div>
          <div className="collapse-content text-sm">
            We reserve the right to refuse service to anyone for any reason at
            any time. You agree not to reproduce, duplicate, copy, sell, resell,
            ...
            service is provided, without express written permission by us. Noble
            Trading is not responsible if information made available on this
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          ...
          <div className="collapse-title font-semibold">Pricing</div>
          <div className="collapse-content text-sm">
            ...
            Service. Certain products or services may be available exclusively
            ...
            according to our Return Policy. Certain products or services may be
            ...
            our products that appear at the merchandise shop and membership
            page. We cannot guarantee that your computer monitor's display of
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" />
          <div className="collapse-title font-semibold">Lawful Use</div>
          <div className="collapse-content text-sm">
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          ...
          <div className="collapse-content text-sm">
            ...
            Noble Trading, our directors, officers, employees, affiliates,
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" />
          <div className="collapse-title font-semibold">Warranties</div>
          <div className="collapse-content text-sm">
            You agree to indemnify, defend, and hold harmless Noble Trading and
            ...
            law or the rights of a third-party. In the event that any provision
            of these Terms of Service is determined to be unlawful, void or
            ...
            enforceability of any other remaining provisions. The obligations
            ...
            purposes. Noble Trading is not responsible for any losses incurred
            as a result of using any of our trading strategies. All trading
            involves a substantial risk of loss and is not suitable for every
            investor. Noble Trading may publish testimonials or descriptions of
            performance history, but these results are not indicative of your
            performance, warranty, or guarantee that similar results will be
            achieved by you. Any trade or investment is at your own risk and all
            information discussed is for informational and educational purposes
            only and should be be considered investment, legal, or tax advice.
            None of the content published on thetradehub.net constitutes a
            recommendation that any securities, transactions, or investment
            strategies is suitable of for any specific trader. Do not engage in
            trading unless you fully understand the nature of the transactions
            you enter into and the extent of your exposure to loss. Seek
            independent advice from your financial advisor if you do not fully
            understand these risks.
          </div>
        </div>
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" />
          <div className="collapse-title font-semibold">Terminations</div>
          <div className="collapse-content text-sm">
            ...
            thereof). The failure of us to exercise or enforce any right or
        ...
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" />
          <div className="collapse-title font-semibold">Jurisdiction</div>
          <div className="collapse-content text-sm">
            These Terms of Service and any separate agreements whereby we
            provide you Services shall be governed by and construed in
            accordance with the laws of CA, United States. You can review the
            most current version of the Terms of Service at any time on this
            page. We reserve the right, at our sole discretion, to update,
            ...
            access to our website or the Service following the posting of any
            changes to these Terms of Service constitutes acceptance of those
            changes. Questions about the Terms of Service should be sent to us
            at info@Noble Trading.com
          </div>
        </div>
        <div className="collapse collapse-arrow bg-base-100 border border-accent my-2">
          <input type="radio" name="my-accordion-2" />
          <div className="collapse-title font-semibold">Refunds</div>
          <div className="collapse-content text-sm">
            You may cancel your subscription at any time. When you cancel your
            subscription, your membership will remain in effect to the date of
            expiration. Refunds will NOT be issued for any current subscription
            AND no credit, refunds, or prorated billing will be provided for
            subscriptions that are canceled mid-month. To prevent being charged
            on the next billing period, cancel the membership subscription. Upon
            cancellation, your membership will remain in effect until the end of
            the billing cycle. We provide a comprehensive 7-day trial completely
            free of charge, with no obligation or requirement for billing
            information. We believe this empowers potential subscribers to fully
            experience our service and make an informed decision about
            subscribing.
          </div>
        </div>
      </div>
