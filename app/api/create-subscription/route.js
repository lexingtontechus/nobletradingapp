...
const supabase = createClient(
  ...
  process.env.SUPABASE_SERVICE_ROLE_KEY!, // ⚠️ server-only, no NEXT_PUBLIC_ prefix
  ...
  await supabase.from("users").upsert(
    {
      ...
      email,
      discord_id: (user.publicMetadata as any)?.discordId ?? null,
      discord_username: (user.publicMetadata as any)?.discordUsername ?? null,
      role: (user.publicMetadata as any)?.role === "admin" ? "admin" : "member",
    },
