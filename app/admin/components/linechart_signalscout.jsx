...
//
// DATA SHAPE (from v_revenue_summary filtered to Signal Scout):
//   { month, revenue_cents, renewals, new_subscriptions, payment_count }
//
// One row per month (already filtered to a single plan by the widget).
...
export function LineChartSignalScout({ data }) {
  ...
  return (
    <div className="container">
      <Card>
        <CardHeader>
          <CardTitle>Signal Scout — Year-To-Date Revenue</CardTitle>
          <CardDescription>
